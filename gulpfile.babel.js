...
function mergeAll(dest) {
  return merge(
    ...
    pipe(['./src/codemirror/lib/**/*'], `./build/${dest}/codemirror/lib`),
    pipe(['./src/codemirror/mode/**/*'], `./build/${dest}/codemirror/mode`),
    pipe(['./src/codemirror/theme/**/*'], `./build/${dest}/codemirror/theme`),
    pipe(['./src/codemirror/addon/**/*'], `./build/${dest}/codemirror/addon`),
  )
}
